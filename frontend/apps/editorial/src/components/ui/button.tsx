...
/**
 * Premium button variants. The `default` is our cobalt CTA; `secondary`
 * is the off-white outline used as the workhorse; `ghost` and `link`
 * are inline triggers. All sizes share the same vertical rhythm so
 * mixed-size button groups don't visually jitter.
 */
