...
@Component
class InitialDeclineHandler extends AbstractDecisionHandler {

    @Override public DecisionType type() { return DecisionType.INITIAL_DECLINE; }
    ...
    public DecisionOutcome decide(SubmissionSummary current, DecisionContext context) {
        ...
        return DecisionOutcome.to(SubmissionStage.SUBMISSION, SubmissionStatus.DECLINED);
    }
}
